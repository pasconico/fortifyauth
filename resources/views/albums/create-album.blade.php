    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="{{ url('/albums/store-album') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control  @error('album_name') is-invalid @enderror"
                            name="album_name" id="album_name" placeholder="Album Name" value="{{ old('album_name') }}">
                        @error('album_name')
                            <div class="text text-danger" role="alert">
                                {{ $message }}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        <input type="text" class="form-control  @error('album_genre') is-invalid @enderror"
                            name="album_genre" id="album_genre" placeholder="Album Genre" value="{{ old('album_genre') }}">
                        @error('album_genre')
                            <div class="text text-danger" role="alert">
                                {{ $message }}
                            </div>
                    ...
                    <div class="md-3 mb-3">
                        ...
                        <textarea class="form-control  @error('album_description') is-invalid @enderror" name="album_description"
                            id="album_description" placeholder="Album Description">{{ old('album_name') }}</textarea>
